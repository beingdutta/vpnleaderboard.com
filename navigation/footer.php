<footer class="footer py-4 border-top" style="--bs-border-color: var(--border-color);">
  <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
    ...
    <div class="d-flex flex-wrap gap-3">
      <a href="/about" class="text-decoration-none footer-link">About</a>
      <a href="/feedback" class="text-decoration-none footer-link">Contact</a>
      <a href="/terms" class="text-decoration-none footer-link">Terms</a>
      <a href="/privacy" class="text-decoration-none footer-link">Privacy</a>
    </div>
  </div>
</footer>
